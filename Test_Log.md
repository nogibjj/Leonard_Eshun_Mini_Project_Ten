...
### Reading All Column Test ### 
Getting columns for air_quality <br />### Transform and Load Test ### 
Creating non-lookup table: air_quality <br />Creating lookup table: indicator <br />Creating lookup table: geo_data <br />Tables created. <br />Skipping the first row... <br />Inserting table data... <br />Inserting table data completed <br />Transform and Load Test Successful
...
### Reading All Column Test ### 
Getting columns for air_quality <br />Asserting the air_quality table has six (6) columns <br />### Transform and Load Test ### 
Creating non-lookup table: air_quality <br />Creating lookup table: indicator <br />Creating lookup table: geo_data <br />Tables created. <br />Skipping the first row... <br />Inserting table data... <br />Inserting table data completed <br />Transform and Load Test Successful
...
### Transform and Load Test ### 
Creating non-lookup table: air_quality <br />Creating lookup table: indicator <br />Creating lookup table: geo_data <br />Tables created. <br />Skipping the first row... <br />Inserting table data... <br />Inserting table data completed <br />### Transform and Load Test ### 
Creating non-lookup table: air_quality <br />Creating lookup table: indicator <br />Creating lookup table: geo_data <br />Tables created. <br />Skipping the first row... <br />Inserting table data... <br />Inserting table data completed <br />Transform and Load Test Successful
...
### One Record Reading Test ### 
Getting columns for air_quality <br />Asserting that row[0][data_value] == 16.4 <br />### Transform and Load Test ### 
Creating non-lookup table: air_quality <br />Creating lookup table: indicator <br />Creating lookup table: geo_data <br />Tables created. <br />Skipping the first row... <br />Inserting table data... <br />Inserting table data completed <br />Transform and Load Test Successful
...
### Record Saving Test ### 
Asserting there's no record in geo_data with ID 100000 <br />Getting columns for geo_data <br />Assert Successful <br />Saving new record with ID 100000 <br />Getting columns for geo_data <br />Executing query... <br />
```sql
...
### Record Saving Test ### 
Asserting there's no record in geo_data with ID 100000 <br />Getting columns for geo_data <br />Assert Successful <br />Saving new record with ID 100000 <br />Getting columns for geo_data <br />### Transform and Load Test ### 
Creating non-lookup table: air_quality <br />Creating lookup table: indicator <br />Creating lookup table: geo_data <br />Tables created. <br />Skipping the first row... <br />Inserting table data... <br />Inserting table data completed <br />Transform and Load Test Successful
...
### Record Saving Test ### 
Asserting there's no record in geo_data with ID 100000 <br />Getting columns for geo_data <br />Assert Successful <br />Saving new record with ID 100000 <br />Getting columns for geo_data <br />Getting columns for geo_data <br />### Transform and Load Test ### 
Creating non-lookup table: air_quality <br />Creating lookup table: indicator <br />Creating lookup table: geo_data <br />Tables created. <br />Skipping the first row... <br />Inserting table data... <br />Inserting table data completed <br />Transform and Load Test Successful
...
### Record Saving Test ### 
Asserting there's no record in geo_data with ID 100000 <br />Getting columns for geo_data <br />Assert Successful <br />Saving new record with ID 100000 <br />Asserting there's now a record in geo_data with ID 100000 <br />Getting columns for geo_data <br />### Transform and Load Test ### 
Creating non-lookup table: air_quality <br />Creating lookup table: indicator <br />Creating lookup table: geo_data <br />Tables created. <br />Skipping the first row... <br />Inserting table data... <br />Inserting table data completed <br />Transform and Load Test Successful
...
### Record Saving Test ### 
Asserting there's no record in geo_data with ID 100000 <br />Getting columns for geo_data <br />Assert Successful <br />Saving new record with ID 100000 <br />Asserting there's now a record in geo_data with ID 100000 <br />Getting columns for geo_data <br />Assert Successful <br />Record Saving Test Successful
...
Asserting there's a record in geo_data for row ID 100000 <br />Getting columns for geo_data <br />### Transform and Load Test ### 
Creating non-lookup table: air_quality <br />Creating lookup table: indicator <br />Creating lookup table: geo_data <br />Tables created. <br />Skipping the first row... <br />Inserting table data... <br />Inserting table data completed <br />Transform and Load Test Successful
...
### Record Deletion Test ### 
Asserting there's a record in geo_data for row ID 100000 <br />Getting columns for geo_data <br />Assert Successful <br />Deleting record with ID 100000 <br />Getting columns for geo_data <br />Executing query... <br />
```sql
...
### Record Deletion Test ### 
Asserting there's a record in geo_data for row ID 100000 <br />Getting columns for geo_data <br />Assert Successful <br />Deleting record with ID 100000 <br />Filtering out record with id 100000 <br />Getting columns for geo_data <br />### Transform and Load Test ### 
Creating non-lookup table: air_quality <br />Creating lookup table: indicator <br />Creating lookup table: geo_data <br />Tables created. <br />Skipping the first row... <br />Inserting table data... <br />Inserting table data completed <br />Transform and Load Test Successful
...
```sql
Select air_quality.*, indicator.* from air_quality inner join indicator on air_quality.fn_indicator_id = indicator.indicator_id
```
